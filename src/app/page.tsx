      ...
      >
        <CardGrid columns={2} className="items-stretch">
          <Card 
            ...
            className="bg-[#F0E6DD]/40 border-accent/10 !pt-2 !pb-4 !px-5 flex flex-col items-start justify-start [&_p]:!text-[#1F1F1F] [&_p]:text-[17px] [&_h3]:!hidden md:col-span-1 h-full"
          />
          <Card 
            variants={{
              hidden: { opacity: 0, y: 24 },
