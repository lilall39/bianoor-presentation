      ...
      >
        <CardGrid columns={3} className="items-start">
          <Card 
            ...
            className="bg-[#FBF7F2] border-accent/10 !pt-4 flex flex-col items-start justify-start [&_p]:!text-[#1F1F1F] [&_p]:text-[17px] [&_h3]:!text-accent [&_h3]:text-[22px] [&_h3]:!mt-0 [&_h3]:!mb-4 [&_p]:whitespace-pre-line [&_p]:text-justify"
          />
          <Card 
            title="Hausse du Bio"
