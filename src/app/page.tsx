      ...
      >
        <CardGrid columns={2} className="items-start">
          <Card 
            ...
            className="bg-[#FFFDFB] border-accent/10 !pt-2 !pb-4 !px-5 flex flex-col items-start justify-start [&_p]:!text-[#1F1F1F] [&_p]:text-[17px] [&_h3]:!text-accent [&_h3]:text-[22px] [&_h3]:!mt-0 [&_h3]:!mb-1 [&_div]:!mb-1 [&_p]:whitespace-pre-line [&_p]:text-justify md:col-span-1"
          />
          <Card 
            title="Hausse du Bio"
          ...
          <Card 
            ...
            className="bg-[#FFFDFB] border-accent/10 !pt-2 !pb-4 !px-5 flex flex-col items-start justify-start [&_p]:!text-[#1F1F1F] [&_p]:text-[17px] [&_h3]:!text-accent [&_h3]:text-[22px] [&_h3]:!mt-0 [&_h3]:!mb-1 [&_div]:!mb-1 [&_p]:whitespace-pre-line [&_p]:text-justify md:col-span-2"
          />
        </CardGrid>
      </Section>
