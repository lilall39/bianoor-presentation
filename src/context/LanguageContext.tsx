...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const translations: Record<Language, Record<string, string>> = {
    fr: {
      ...
      opp_card1_desc: "La consommation de dattes en Europe <strong class='text-accent font-bold'>progresse constamment</strong>, portée par l’intérêt pour les aliments naturels, bio et énergétiques. <strong class='text-accent font-bold'>Les importations augmentent chaque année</strong>, reflétant une demande dynamique. En France, <strong class='text-accent font-bold'>plusieurs milliers de tonnes de dattes</strong> sont consommées annuellement, avec <strong class='text-accent font-bold'>un marché retail estimé à plus de 100 millions d’euros</strong> pour les dattes conditionnées. Les données observées indiquent une <strong class='text-accent font-bold'>dynamique positive</strong> de la demande, avec une <strong class='text-accent font-bold'>croissance annuelle</strong> moyenne d’environ 4–5 %, particulièrement marquée autour de périodes culturelles comme le Ramadan.",
      opp_card2_title: "Croissance du marché des dattes Bio : environ 6% / an",
      opp_card2_desc: "<strong class='text-accent font-bold'>La demande de dattes bio croît</strong> en Europe, portée par l’<strong class='text-accent font-bold'>intérêt croissant</strong> des consommateurs pour les aliments naturels, sains et certifiés. <strong class='text-accent font-bold'>Les importations</strong> de dattes biologiques <strong class='text-accent font-bold'>vers l’UE augmentent</strong>. En France, une part croissante des dattes consommées est <strong class='text-accent font-bold'>issue de l’agriculture biologique</strong>. <strong class='text-accent font-bold'>Le segment bio</strong> représente une part significative du marché retail des dattes conditionnées <strong class='text-accent font-bold'>(estimé à plus de 100 millions d’euros)</strong>, avec une progression régulière observée au cours des dernières années. Les données de marché indiquent <strong class='text-accent font-bold'>une dynamique soutenue</strong> pour les dattes bio, avec une <strong class='text-accent font-bold'>croissance annuelle</strong> moyenne observée autour de 4–6 %.",
      ...
      risk2_text: "Maintenir une qualité constante, des certifications fiables et des process contrôlés à chaque étape.",
      ...
      risk4_text: "Concurrence d’acteurs low-cost, importateurs peu différenciés et produits de qualité inégale.",
      risk5_title: "Saisonnalité de la demande",
      risk5_text: "Forte concentration des ventes sur certaines périodes (ex : Ramadan), nécessité d’anticiper les volumes et les stocks.",
      risk6_title: "Risque réglementaire & administratif",
      risk6_text: "Évolutions des normes (bio, import, traçabilité), contraintes douanières et contrôles sanitaires.",
      phase1_subtitle: "Phase 1",
      phase1_title: "Les Dattes : Notre produit d'entrée",
      phase1_quality: "Classement TasteAtlas – Référence mondiale (experts)",
      phase1_desc: "La Deglet Nour algérienne est classée n°1 dans la catégorie « douceur moyenne » par TasteAtlas. Elle se distingue par son équilibre sucre/arômes, sa texture fondante non écœurante et sa reconnaissance internationale, ce qui lui donne une position premium entre les dattes très sucrées et les dattes sèches.",
      phase1_formats: "Positionnement premium : idéale en coffrets dégustation, épiceries fines, cadeaux B2B.",
      phase1_recurrence: "Avantage marché : produit de référence reconnu mondialement, facile à valoriser en marque.",
    ...
    en: {
      ...
      opp_card1_desc: "Date consumption in Europe is <strong class='text-accent font-bold'>steadily increasing</strong>, driven by interest in natural, organic, and energetic foods. <strong class='text-accent font-bold'>Imports increase every year</strong>, reflecting dynamic demand. In France, <strong class='text-accent font-bold'>several thousand tons of dates</strong> are consumed annually, with a <strong class='text-accent font-bold'>retail market estimated at over 100 million euros</strong> for packaged dates. Observed data indicates a <strong class='text-accent font-bold'>positive demand dynamic</strong>, with an <strong class='text-accent font-bold'>average annual growth</strong> of about 4-5%, particularly marked around cultural periods like Ramadan.",
      opp_card2_title: "Organic date market growth: around 6% / year",
      opp_card2_desc: "<strong class='text-accent font-bold'>Demand for organic dates is growing</strong> in Europe, driven by <strong class='text-accent font-bold'>increasing consumer interest</strong> in natural, healthy, and certified foods. <strong class='text-accent font-bold'>Organic date imports</strong> to the EU <strong class='text-accent font-bold'>are rising</strong>. In France, a growing share of dates consumed comes <strong class='text-accent font-bold'>from organic farming</strong>. <strong class='text-accent font-bold'>The organic segment</strong> represents a significant share of the retail market for packaged dates <strong class='text-accent font-bold'>(estimated at over 100 million euros)</strong>, with steady progression observed in recent years. Market data indicates <strong class='text-accent font-bold'>sustained dynamics</strong> for organic dates, with an <strong class='text-accent font-bold'>average annual growth</strong> observed around 4-6%.",
      ...
      phase1_quality: "TasteAtlas Ranking – Global Reference (experts)",
      phase1_desc: "Algerian Deglet Nour is ranked #1 in the 'medium sweetness' category by TasteAtlas. It stands out for its balance of sugar and aromas, its melting, non-cloying texture, and its international recognition, giving it a premium position between very sweet dates and dry dates.",
      phase1_formats: "Premium positioning: ideal for tasting boxes, fine grocery stores, B2B gifts.",
      phase1_recurrence: "Market advantage: globally recognized reference product, easy to build brand value.",
