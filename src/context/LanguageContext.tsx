...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const translations: Record<Language, Record<string, string>> = {
    fr: {
      ...
      phase1_desc: "Produit B2B existant depuis 20 ans avec une identité algérienne forte. Le bio est rare sur ce segment, ce qui nous confère un avantage compétitif majeur.",
